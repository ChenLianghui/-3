...
- (void)viewDidLoad {
    ...
    self.FullView.contentSize = CGSizeMake(kScreenSize.width, kScreenSize.height*3.3);
...
//    flowLayout.sectionInset = UIEdgeInsetsMake(20, 10, 10, 10);
    ...
    self.HotSearchCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, kScreenSize.width-40*KfitWidth, 320*KfitHigth)collectionViewLayout:flowLayout];
    self.HotSearchCollectionView.backgroundColor = [UIColor whiteColor];
    self.HotSearchCollectionView.scrollEnabled = NO;
...
-(void)initSortCollectionView{
    ...
    self.SortCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 30, kScreenSize.width-20, 350*KfitHigth) collectionViewLayout:flowlayout];
